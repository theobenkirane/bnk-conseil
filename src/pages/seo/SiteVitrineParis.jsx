        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-xl max-w-2xl mb-8 leading-relaxed">
              "Entrepreneurs parisiens, indépendants, startups : un site pro pour vous démarquer dans la capitale."
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-xl mx-auto">
              "Que vous soyez dans le 1er ou le 20e, on s'adapte à votre emploi du temps."
            </p>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl p-6 border border-violet-100 shadow-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  "On peut se retrouver dans vos locaux, votre café de travail ou un espace de coworking parisien."
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-xl mx-auto">
              "Chaque métier a ses codes. On conçoit votre site en fonction de ce que vos clients parisiens cherchent."
            </p>
          </motion.div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-600 text-xl mb-8 max-w-xl mx-auto">
              "Un projet parisien ? Échangeons autour d'un appel de 20 minutes."
            </p>
            <Link
              to="/rdv"
