...
export const HERO = {
  ...
  facts: [
    { k: '200+', v: 'clients onboardés / mois' },
    { k: '150–250 %', v: 'des objectifs atteints' },
    { k: '+80 %', v: "taux d'upsell" },
    { k: '5 ans', v: "d'expérience terrain" },
  ],
  cta: {
...
export const EXPERIENCE = [
  {
    ...
    role: 'Account Manager',
    company: 'LegalPlace',
    logo: '/portfolio/legalplace.webp',
    type: 'Alternance',
  ...
  },
  {
    ...
    company: 'Groupagora',
    logo: '/portfolio/groupagora.webp',
    type: 'Alternance',
    location: 'Pérols',
    period: 'Sep. → Nov. 2023',
